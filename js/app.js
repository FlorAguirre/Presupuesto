...
class Presupuesto {
    ...
    calcularRestante(){
        const gastado = this.gastos.reduce((total, gasto)=> total + gasto.cantidad, 0 ); // Acumula los valores
...
class UI{
    ...
    agregarGastoListado(gastos){
        ...
        gastos.forEach( gasto => {
            ...
            nuevoGasto.dataset.id = id; // Agregarle el data-id al li.
/* 
...
/*     console.log(nombre); */
    ...
    const gasto = { nombre, cantidad, id: Date.now()} // es lo contrario a destruction

    // Añade un nuevo gasto

    presupuesto.nuevoGasto( gasto );

    // Mensaje de que se agrgeo el gasto correctamente
